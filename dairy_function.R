...
for(i in 1:(nrow(animal_number)-1)){
  if (animal_number$Fert_applied[i]==0){
    animal_number$Total_N_barn_stored[i+1] = animal_number$Total_N_barn_stored[i] + animal_number$total_N_barn[i+1] #total_N_BARN that stored
    animal_number$Total_P_barn_stored[i+1] = animal_number$Total_P_barn_stored[i] + animal_number$total_P_barn[i+1]  #total_P_BARN that stored
    animal_number$TotalNP_barn[i+1]=animal_number$TotalNP_barn[i]+animal_number$totalNP[i]
  }else{
